...
A boolean `elif` following a non-boolean condition still receives the exhaustiveness fix. The type
of the first condition does not determine how later conditions are diagnosed.
